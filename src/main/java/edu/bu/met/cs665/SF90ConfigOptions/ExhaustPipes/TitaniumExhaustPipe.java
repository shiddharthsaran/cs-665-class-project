 ...
 * Date: 04/23/2024
 * File Name: TitaniumExhaustPipe.java
 * Description: TitaniumExhaustPipe class represents an option for SF90 car's exhaust system made from titanium material.
 */
