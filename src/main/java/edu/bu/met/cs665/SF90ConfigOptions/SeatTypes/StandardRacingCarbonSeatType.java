 ...
 * Date: 04/23/2024
 * File Name: StandardRacingCarbonSeatType.java
 * Description: StandardRacingCarbonSeatType class represents the standard racing carbon seat type option for the Ferrari SF90.
 */
