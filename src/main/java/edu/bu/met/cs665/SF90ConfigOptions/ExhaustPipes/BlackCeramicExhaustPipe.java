 ...
 * Date: 04/23/2024
 * File Name: BlackCeramicExhaustPipe.java
 * Description: BlackCeramicExhaustPipe class represents an option for SF90 car's exhaust system coated with black ceramic.
 */
