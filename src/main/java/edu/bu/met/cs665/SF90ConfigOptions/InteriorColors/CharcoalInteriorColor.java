 ...
 * Date: 04/23/2024
 * File Name: CharcoalInteriorColor.java
 * Description: CharcoalInteriorColor class represents an option for SF90 car's interior color in a dark, sophisticated shade of charcoal.
 */
