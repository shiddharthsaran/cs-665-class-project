 ...
 * Date: 04/23/2024
 * File Name: DefaultInteriorDetail.java
 * Description: DefaultInteriorDetail class represents the standard configuration of interior features provided by the manufacturer for the Ferrari SF90.
 */
package edu.bu.met.cs665.SF90ConfigOptions.InteriorDetails;
