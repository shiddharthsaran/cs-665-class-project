 ...
 * Date: 04/23/2024
 * File Name: StandardExhaustPipe.java
 * Description: StandardExhaustPipe class represents the default configuration provided by the manufacturer for SF90 car's exhaust system.
 */
