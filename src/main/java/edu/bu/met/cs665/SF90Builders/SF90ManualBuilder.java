 ...
 * Date: 04/23/2024
 * File Name: SF90ManualBuilder.java
 * Description: SF90ManualBuilder class implements the SF90BuilderInterface and is responsible for building SF90Manual objects
...
public class SF90ManualBuilder implements SF90BuilderInterface{
    ...
    /**
     * Method to construct and return a SF90Manual object with the configured options.
     * @return A SF90Manual object with the configured options.
     */
